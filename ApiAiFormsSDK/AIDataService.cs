    ...
    public class AIDataService
    {
        ...
        public AIResponse Request(AIRequest request)
        {
            ...
            try
            {
                ...
                using (var streamWriter = new StreamWriter(httpRequest.GetRequestStreamAsync().Result))
                {
                    streamWriter.Write(jsonRequest);
                    streamWriter.Flush();
                }

                var httpResponse = httpRequest.GetResponseAsync().Result as HttpWebResponse;
                using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
                {
                    ...
                    aiResponse.SetJsonResponseString(result);
        ...
        public AIResponse VoiceRequest(Stream voiceStream, RequestExtras requestExtras = null)
        {
            ...
            try
            {
                ...
                aiResponse.SetJsonResponseString(responseJsonString);
        ...
        public AIResponse VoiceRequestNew(Stream voiceStream, RequestExtras requestExtras = null)
        {
            var request = new AIRequest();
            request.Language = config.Language.code;
            request.Timezone = TimeZoneInfo.Local.StandardName;
